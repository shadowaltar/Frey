...
{
    public partial class MainViewModel : MainViewModelBase<TradeWatchDataAccess>,
        IMainViewModel, IHandle<ActivityMessage<IMainViewModel>>
    {
        public override sealed string ProgramName { get { return "Trade Screen"; } }

        public MainViewModel(IDataAccessFactory<TradeWatchDataAccess> dataAccessFactory,
